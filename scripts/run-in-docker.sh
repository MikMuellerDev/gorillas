...
# Default values
image="maxscha/research-environment:latest"
command="bash"
gpus="none"
...
# IMPORTANT: Use -v /home/username/.cache:/home/mambauser/.cache to mount your cache folder to the docker container. The username inside the container is "mamba".
